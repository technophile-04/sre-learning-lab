...
import { JourneyPanelV2 } from "./JourneyPanelV2";
import { CardRendererV2, SCENARIO_DEPS } from "./cardsV2";
...
const PANEL_COLLAPSED_KEY = "deck-v2:panel-collapsed";
...
export function DeckV2() {
  ...
  return (
    <TutorBusContext.Provider value={bus}>
      <div className={`deck-shell deck-shell-v2 ${panelCollapsed ? "deck-shell-collapsed" : ""}`}>
        <JourneyPanelV2
          mobileOpen={navOpen}
          ...
          <div className={`v2-center-col ${panelCollapsed ? "" : "v2-center-col-open"}`}>
            ...
            <div className="deck-stage">
              ...
              <div key={card.id} style={{ position: "relative", zIndex: 1 }}>
                <CardRendererV2 card={card} chain={chain} />
              </div>
            </div>
        ...
        <aside className="v2-right" aria-label="contract and tutor">
          ...
          <div className="v2-right-body">
            ...
            <div className={`v2-panel ${rightTab === "tutor" ? "v2-panel-on" : ""}`} aria-hidden={rightTab !== "tutor"}>
              <TutorPanel task={tutorTask} attempted={attempted} stage={card.title} surface="crowdfunding-v2" />
            </div>
          </div>
        </aside>
      </div>
